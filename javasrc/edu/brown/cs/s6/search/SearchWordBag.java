...
/* SVN: $Id: SearchWordBag.java,v 1.2 2015/09/23 17:58:11 spr Exp $ */
...
public class SearchWordBag implements SearchWordConstants
{
...
public SearchWordBag(String text)
{
   this();
...
public SearchWordBag(SearchWordBag bag)
{
   this();
...
public void addWords(String text)
{
   ...
   SearchWordStemmer stm = new SearchWordStemmer();
   ...
   for (int i = 0; i < ln; ++i) {
	 ...
	 if (havealpha) {
	    Collection<String> wds =  SearchWordFactory.getCandidateWords(stm,text,start,i-start);
	    if (wds != null) {
	       for (String wd : wds) {
...
public void addWords(SearchWordBag bag)
{
   if (bag == null) return;
...
public void removeWords(SearchWordBag bag)
{
...
public double cosine(SearchWordBag b2)
{
   SearchWordBag b1 = this;
...
}	// end of class SearchWordBag




/* end of SearchWordBag.java */
