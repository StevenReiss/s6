...
private JavaFragment		java_fragment;
...
JavaTester(JavaFragment f,S6Request.Search r,JavaContext ctx,CoseSource src)
{
   java_fragment = f;
   for_request = r;
   user_context = ctx;
...
private void producePackageFiles(Map<String,String> idmap) throws S6Exception
{
   ...
   if (java_fragment.getResources() != null) {
      for (CoseResource rsrc : java_fragment.getResources()) {
